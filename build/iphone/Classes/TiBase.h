...
// in simulator we redefine to format for life Developer console
...
{\
	NSString * exceptionName = [@"org.life." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.life";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIlifeNativeItemNone = -1, 
	UIlifeNativeItemSpinner = -2,
	UIlifeNativeItemProgressBar = -3,
	
	UIlifeNativeItemSlider = -4,
	UIlifeNativeItemSwitch = -5,
	UIlifeNativeItemMultiButton = -6,
	UIlifeNativeItemSegmented = -7,
	
	UIlifeNativeItemTextView = -8,
	UIlifeNativeItemTextField = -9,
	UIlifeNativeItemSearchBar = -10,
	
	UIlifeNativeItemPicker = -11,
	UIlifeNativeItemDatePicker = -12,
	
	UIlifeNativeItemInfoLight = -13,
	UIlifeNativeItemInfoDark = -14,
	
	UIlifeNativeItemDisclosure = -15,
	
	UIlifeNativeItemContactAdd = -16
};
